...
%% save structures
% save('~/Dropbox/ASU/SINE/Data/feeder_analysis/input_2_results_doubleS.mat','n_tot','e_tot','err_tot','-v7.3')
%% save csv results
% writetable(struct2tab_with_pad(KL),'~/Dropbox/ASU/SINE/Data/feeder_analysis/input_2_KL_doubleS.csv');
% writetable(struct2tab_with_pad(T_hist),'~/Dropbox/ASU/SINE/Data/feeder_analysis/input_2_T_hist_doubleS.csv');
% writetable(struct2tab_with_pad(T_fit),'~/Dropbox/ASU/SINE/Data/feeder_analysis/input_2_T_fit_doubleS.csv');
